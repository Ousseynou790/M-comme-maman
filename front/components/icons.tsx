...
/** TikTok : logo plein comme celui de WhatsApp, au trait il ne se reconnait
    plus. Monochrome en `currentColor` — c'est l'usage officiel du mark, et la
    couleur reste celle de la pastille qui le porte. */
export function IconTikTok({ className = base }: Props) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" className={className}>
